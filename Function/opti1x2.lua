...
do
	...
	Library.GUI = Create("ScreenGui", {Name = game:GetService "HttpService":GenerateGUID(false), Parent = i:IsStudio() and j.PlayerGui or game:GetService "Players".LocalPlayer.PlayerGui})
